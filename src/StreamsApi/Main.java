...
public class Main {
  ...
  //      System.out.println(stream.count());   -> exception already used (terminated-if once used)
       ...
       list.stream().
        ...
        list.stream().
                filter(a -> a%2 == 0).
                distinct().
                sorted((a,b) -> b-a).          //decreasing order sort
                forEach(a -> System.out.println(a));
...
//                System.out.println(sum);
        ...
        List<ArrayList<String>> employeeList2 = empList.stream().
                filter(a -> a.designation.equals("sde1")).
                distinct().
                sorted((a,b) -> b.salary - a.salary).
                map(a -> a.emails).
        ...
        List<String> employeeList1 = empList.stream().
                filter(a -> a.designation.equals("sde1")).
                distinct().
                sorted((a,b) -> b.salary - a.salary).
